...
for bm in bms:
    ...
    commaprint([bm,"",mymin(noint),mymin(noprem),mymin(prem),"",
                      myavg(noint),myavg(noprem),myavg(prem),"",
                      mymax(noint),mymax(noprem),mymax(prem),"",
                      jittr(noint),jittr(noprem),jittr(prem)])
