...
PULP_DRIVER_MODULE_SUBDIRS = pulp-driver
PULP_DRIVER_INSTALL_TARGET = YES
PULP_DRIVER_DEPENDENCIES = libpulp

PULP_DRIVER_APPS_DIR = $(BR2_EXTERNAL_HERO_PATH)/apps/
...
PULP_DRIVER_PLATFORM = ARIANE
PULP_DRIVER_MK_OPTS = PLATFORM=$(PULP_DRIVER_PLATFORM) CFLAGS="$(PULP_DRIVER_CFLAGS)"
