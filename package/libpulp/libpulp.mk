...
LIBPULP_PLATFORM = ARIANE
LIBPULP_MK_OPTS = PLATFORM=$(LIBPULP_PLATFORM) CFLAGS="$(LIBPULP_CFLAGS)"
...
define LIBPULP_CLEAN_BUILD
	$(LIBPULP_TARGET_MAKE_ENV) $(MAKE) -C $(@D) clean
endef
LIBPULP_PRE_BUILD_HOOKS += LIBPULP_CLEAN_BUILD

define LIBPULP_BUILD_CMDS
	$(LIBPULP_TARGET_MAKE_ENV) $(MAKE) -C $(@D) build
endef
