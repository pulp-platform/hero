...
HERO_OPENMP_SITE = $(BR2_EXTERNAL_HERO_PATH)/toolchain/openmp
...
HERO_OPENMP_CONF_ENV = LIBGOMP_PLUGIN_PULP_HERO_CPPFLAGS="-DPLATFORM=$(HERO_OPENMP_PLATFORM)" HERO_PULP_INC_DIR=${HERO_OPENMP_PULP_INC_DIR}
