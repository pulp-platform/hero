...
HERO_SUPPORT_MODULE_MAKE_OPTS = PLATFORM=$(HERO_SUPPORT_PLATFORM)
...
HERO_SUPPORT_TARGET_MAKE_ENV = $(TARGET_MAKE_ENV) PLATFORM=$(HERO_SUPPORT_PLATFORM) \
		HERO_PULP_INC_DIR=$(BR2_EXTERNAL_HERO_PATH)/support/pulp-sdk/pkg/sdk/dev/install/include/ \
