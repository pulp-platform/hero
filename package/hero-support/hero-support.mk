...
HERO_SUPPORT_CFLAGS = -I$(@D)/libpulp/inc -I$(HERO_SUPPORT_PULP_INC) -DDEBUG_LEVEL=$(BR2_PACKAGE_HERO_SUPPORT_DEBUG_LEVEL)
...
define HERO_SUPPORT_CLEAN_BUILD
  echo $(BR2_PACKAGE_HERO_SUPPORT_DEBUG_LEVEL)
