...
#define ARCHI_APB_SOC_BYPASS_ENABLE_BIT            0
#define ARCHI_APB_SOC_BYPASS_CLUSTER_POWER_BIT     1        
#define ARCHI_APB_SOC_BYPASS_CLUSTER_CLOCK_BIT     2        
#define ARCHI_APB_SOC_BYPASS_FLL_RETENTIVE_BIT     3
#define ARCHI_APB_SOC_BYPASS_FLL_OFF_BIT           4
#define ARCHI_APB_SOC_BYPASS_CLUSTER_RESET_BIT     5
#define ARCHI_APB_SOC_BYPASS_CLUSTER_ISOLATE_BIT   6
#define ARCHI_APB_SOC_BYPASS_CLUSTER_RETENTIVE_BIT 7
#define ARCHI_APB_SOC_BYPASS_POWER_OK_BIT          8
#define ARCHI_APB_SOC_BYPASS_CLOCK_OK_BIT          9
#define ARCHI_APB_SOC_BYPASS_POWER_DOWN_BIT        10
