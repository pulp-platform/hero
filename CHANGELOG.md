...
### Changed
- Hardware:
  - `riscv` core: Remove performance counter registers that were only available in simulation.  RTL
    simulation now has the same number of performance registers available as on the FPGA.
