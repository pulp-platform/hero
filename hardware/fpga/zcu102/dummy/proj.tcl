...
#
# dummy.tcl: Tcl script for re-creating project 'dummy'
#
# Generated by Vivado on Thu Nov 14 22:17:26 CET 2019
...
#
# 1. This project restoration tcl script (dummy.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/scratch/msc19f8/workspace/temp/hero-v3/hardware/fpga/zcu102/dummy/dummy/dummy.srcs/sources_1/imports/hdl/design_1_wrapper.v"
#
...
set orig_proj_dir "[file normalize "$origin_dir/dummy"]"
...
set files [list \
 [file normalize "${origin_dir}/dummy/dummy.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"]\
]
...
proc cr_bd_design_1 { parentCell } {
  ...
  # Create instance: axi_bram_ctrl_cluster1, and set properties
  set axi_bram_ctrl_cluster1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_bram_ctrl:4.1 axi_bram_ctrl_cluster1 ]
  set_property -dict [ list \
   CONFIG.SINGLE_PORT_BRAM {1} \
 ] $axi_bram_ctrl_cluster1

  # Create instance: axi_bram_ctrl_cluster2, and set properties
  set axi_bram_ctrl_cluster2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_bram_ctrl:4.1 axi_bram_ctrl_cluster2 ]
  set_property -dict [ list \
   CONFIG.SINGLE_PORT_BRAM {1} \
 ] $axi_bram_ctrl_cluster2

  # Create instance: axi_bram_ctrl_cluster_bram, and set properties
  set axi_bram_ctrl_cluster_bram [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 axi_bram_ctrl_cluster_bram ]
  set_property -dict [ list \
   CONFIG.Memory_Type {True_Dual_Port_RAM} \
 ] $axi_bram_ctrl_cluster_bram

  # Create instance: axi_bram_ctrl_dbg, and set properties
  set axi_bram_ctrl_dbg [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_bram_ctrl:4.1 axi_bram_ctrl_dbg ]
  set_property -dict [ list \
   CONFIG.SINGLE_PORT_BRAM {1} \
 ] $axi_bram_ctrl_dbg

  # Create instance: axi_bram_ctrl_l2, and set properties
  set axi_bram_ctrl_l2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_bram_ctrl:4.1 axi_bram_ctrl_l2 ]
  set_property -dict [ list \
   CONFIG.SINGLE_PORT_BRAM {1} \
 ] $axi_bram_ctrl_l2

  # Create instance: axi_bram_ctrl_l2_bram, and set properties
  set axi_bram_ctrl_l2_bram [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 axi_bram_ctrl_l2_bram ]
  set_property -dict [ list \
   CONFIG.Memory_Type {True_Dual_Port_RAM} \
 ] $axi_bram_ctrl_l2_bram

  # Create instance: axi_bram_ctrl_mbox, and set properties
  set axi_bram_ctrl_mbox [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_bram_ctrl:4.1 axi_bram_ctrl_mbox ]
  set_property -dict [ list \
   CONFIG.SINGLE_PORT_BRAM {1} \
 ] $axi_bram_ctrl_mbox

  # Create instance: axi_bram_ctrl_rab, and set properties
  set axi_bram_ctrl_rab [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_bram_ctrl:4.1 axi_bram_ctrl_rab ]
  set_property -dict [ list \
   CONFIG.SINGLE_PORT_BRAM {1} \
 ] $axi_bram_ctrl_rab
  ...
  connect_bd_intf_net -intf_net axi_bram_ctrl_0_BRAM_PORTA [get_bd_intf_pins axi_bram_ctrl_0_bram/BRAM_PORTA] [get_bd_intf_pins axi_bram_ctrl_dbg/BRAM_PORTA]
  connect_bd_intf_net -intf_net axi_bram_ctrl_cluster2_BRAM_PORTA [get_bd_intf_pins axi_bram_ctrl_cluster2/BRAM_PORTA] [get_bd_intf_pins axi_bram_ctrl_cluster_bram/BRAM_PORTB]
  connect_bd_intf_net -intf_net axi_bram_ctrl_cluster_BRAM_PORTA [get_bd_intf_pins axi_bram_ctrl_cluster1/BRAM_PORTA] [get_bd_intf_pins axi_bram_ctrl_cluster_bram/BRAM_PORTA]
  connect_bd_intf_net -intf_net axi_bram_ctrl_l2_BRAM_PORTA [get_bd_intf_pins axi_bram_ctrl_l2/BRAM_PORTA] [get_bd_intf_pins axi_bram_ctrl_l2_bram/BRAM_PORTA]
  connect_bd_intf_net -intf_net axi_bram_ctrl_mbox_BRAM_PORTA [get_bd_intf_pins axi_bram_ctrl_l2_bram/BRAM_PORTB] [get_bd_intf_pins axi_bram_ctrl_mbox/BRAM_PORTA]
  connect_bd_intf_net -intf_net axi_bram_ctrl_rab_BRAM_PORTA [get_bd_intf_pins axi_bram_ctrl_0_bram/BRAM_PORTB] [get_bd_intf_pins axi_bram_ctrl_rab/BRAM_PORTA]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins axi_bram_ctrl_dbg/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M02_AXI [get_bd_intf_pins axi_bram_ctrl_rab/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M03_AXI [get_bd_intf_pins axi_bram_ctrl_l2/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M04_AXI [get_bd_intf_pins axi_bram_ctrl_mbox/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M05_AXI [get_bd_intf_pins axi_bram_ctrl_cluster1/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M06_AXI [get_bd_intf_pins axi_bram_ctrl_cluster2/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M06_AXI]
  ...
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_cluster1/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_cluster2/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_dbg/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_l2/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_mbox/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_rab/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/M04_ARESETN] [get_bd_pins ps8_0_axi_periph/M05_ARESETN] [get_bd_pins ps8_0_axi_periph/M06_ARESETN] [get_bd_pins ps8_0_axi_periph/M07_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins ps8_0_axi_periph/S01_ARESETN] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins axi_intc_0/intr] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_bram_ctrl_cluster1/s_axi_aclk] [get_bd_pins axi_bram_ctrl_cluster2/s_axi_aclk] [get_bd_pins axi_bram_ctrl_dbg/s_axi_aclk] [get_bd_pins axi_bram_ctrl_l2/s_axi_aclk] [get_bd_pins axi_bram_ctrl_mbox/s_axi_aclk] [get_bd_pins axi_bram_ctrl_rab/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins ps8_0_axi_periph/M04_ACLK] [get_bd_pins ps8_0_axi_periph/M05_ACLK] [get_bd_pins ps8_0_axi_periph/M06_ACLK] [get_bd_pins ps8_0_axi_periph/M07_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins ps8_0_axi_periph/S01_ACLK] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  create_bd_addr_seg -range 0x00008000 -offset 0xB0000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_bram_ctrl_dbg/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
  create_bd_addr_seg -range 0x00200000 -offset 0xB1200000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_bram_ctrl_cluster2/S_AXI/Mem0] SEG_axi_bram_ctrl_cluster2_Mem0
  create_bd_addr_seg -range 0x00200000 -offset 0xB1000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_bram_ctrl_cluster1/S_AXI/Mem0] SEG_axi_bram_ctrl_cluster_Mem0
  create_bd_addr_seg -range 0x00040000 -offset 0xB2000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_bram_ctrl_l2/S_AXI/Mem0] SEG_axi_bram_ctrl_l2_Mem0
  create_bd_addr_seg -range 0x00001000 -offset 0xB3000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_bram_ctrl_mbox/S_AXI/Mem0] SEG_axi_bram_ctrl_mbox_Mem0
  create_bd_addr_seg -range 0x00010000 -offset 0xA8030000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_bram_ctrl_rab/S_AXI/Mem0] SEG_axi_bram_ctrl_rab_Mem0
  create_bd_addr_seg -range 0x00001000 -offset 0xA8080000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] SEG_axi_gpio_0_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0xA8050000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_intc_0/S_AXI/Reg] SEG_axi_intc_0_Reg
...
#  -string -flagsOSRD
preplace port led_8bits -pg 1 -lvl 5 -x 1640 -y 920 -defaultsOSRD
preplace inst axi_bram_ctrl_0_bram -pg 1 -lvl 4 -x 1490 -y 770 -defaultsOSRD
preplace inst axi_bram_ctrl_cluster1 -pg 1 -lvl 3 -x 1220 -y 80 -defaultsOSRD
preplace inst axi_bram_ctrl_cluster2 -pg 1 -lvl 3 -x 1220 -y 220 -defaultsOSRD
preplace inst axi_bram_ctrl_cluster_bram -pg 1 -lvl 4 -x 1490 -y 210 -defaultsOSRD
preplace inst axi_bram_ctrl_dbg -pg 1 -lvl 3 -x 1220 -y 640 -defaultsOSRD
preplace inst axi_bram_ctrl_l2 -pg 1 -lvl 3 -x 1220 -y 360 -defaultsOSRD
preplace inst axi_bram_ctrl_l2_bram -pg 1 -lvl 4 -x 1490 -y 490 -defaultsOSRD
preplace inst axi_bram_ctrl_mbox -pg 1 -lvl 3 -x 1220 -y 500 -defaultsOSRD
preplace inst axi_bram_ctrl_rab -pg 1 -lvl 3 -x 1220 -y 780 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 3 -x 1220 -y 920 -defaultsOSRD
preplace inst ps8_0_axi_periph -pg 1 -lvl 2 -x 850 -y 460 -defaultsOSRD
preplace inst rst_ps8_0_99M -pg 1 -lvl 1 -x 340 -y 460 -defaultsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 1 -x 340 -y 260 -defaultsOSRD
preplace inst axi_intc_0 -pg 1 -lvl 1 -x 340 -y 660 -defaultsOSRD
preplace inst xlconstant_0 -pg 1 -lvl 1 -x 340 -y 820 -defaultsOSRD
preplace netloc rst_ps8_0_99M_peripheral_aresetn 1 0 3 10 560 690 170 1070
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 3 0 170 680 160 1060
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 0 2 30 360 670
preplace netloc axi_intc_0_irq 1 0 2 30 350 660
preplace netloc xlconstant_0_dout 1 0 2 20 570 650
preplace netloc axi_gpio_0_GPIO 1 3 2 NJ 920 NJ
preplace netloc axi_bram_ctrl_0_BRAM_PORTA 1 3 1 1360 640n
preplace netloc axi_bram_ctrl_cluster_BRAM_PORTA 1 3 1 1360 80n
preplace netloc axi_bram_ctrl_cluster2_BRAM_PORTA 1 3 1 N 220
preplace netloc ps8_0_axi_periph_M00_AXI 1 2 1 1030 390n
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_FPD 1 1 1 670 230n
preplace netloc axi_bram_ctrl_mbox_BRAM_PORTA 1 3 1 N 500
preplace netloc axi_bram_ctrl_rab_BRAM_PORTA 1 3 1 N 780
preplace netloc ps8_0_axi_periph_M01_AXI 1 2 1 1050 410n
preplace netloc ps8_0_axi_periph_M02_AXI 1 2 1 1010 430n
preplace netloc ps8_0_axi_periph_M03_AXI 1 2 1 1040 340n
preplace netloc ps8_0_axi_periph_M04_AXI 1 2 1 1020 470n
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM1_FPD 1 1 1 700 230n
preplace netloc ps8_0_axi_periph_M05_AXI 1 2 1 1000 60n
preplace netloc ps8_0_axi_periph_M06_AXI 1 2 1 1080 200n
preplace netloc axi_bram_ctrl_l2_BRAM_PORTA 1 3 1 1360 360n
preplace netloc ps8_0_axi_periph_M07_AXI 1 0 3 30 750 NJ 750 1000
levelinfo -pg 1 -20 340 850 1220 1490 1640
pagesize -pg 1 -db -bbox -sgen -20 -90 1760 1000
"
}
