...
'/usr/include', #systemc
'-isystem',
'/opt/verilator_v4.222/share/verilator/include',
'-isystem',
'/opt/riscv/riscv32-unknown-linux-gnu/include/c++/11.1.0/riscv32-unknown-linux-gnu/bits',
'-isystem',
'/opt/riscv/riscv32-unknown-linux-gnu/include/c++/11.1.0/riscv32-unknown-linux-gnu/ext',
'-isystem',
p.abspath(./src),
'-isystem',
p.abspath(./include),
'-isystem',
p.abspath(../sim_vlt/worklib),
'-std=c++17',
]
