...
analyze -format sverilog  -define INVECAS -work work ${IPS_PATH}/pulp_cluster/packages/pulp_cluster_package.sv
analyze -format sverilog  -define INVECAS -work work ${IPS_PATH}/pulp_cluster/packages/apu_package.sv
analyze -format sverilog  -define INVECAS -work work ${IPS_PATH}/pulp_cluster/rtl/core_region.sv
...
analyze -format sverilog  -define INVECAS -work work ${IPS_PATH}/pulp_cluster/rtl/cluster_clock_gate.sv
analyze -format sverilog  -define INVECAS -work work ${IPS_PATH}/pulp_cluster/rtl/cluster_timer_wrap.sv
analyze -format sverilog  -define INVECAS -work work ${IPS_PATH}/pulp_cluster/rtl/cluster_event_map.sv
...
analyze -format sverilog  -define INVECAS -work work ${IPS_PATH}/pulp_cluster/rtl/pulp_cluster.sv
