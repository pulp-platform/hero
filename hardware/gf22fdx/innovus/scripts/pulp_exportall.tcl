...
rcOut -rc_corner rccCmaxDP_125C   -spef out/pulp_soc.rccCmaxDP_125C.spef.gz
rcOut -rc_corner rccCminDP_125C   -spef out/pulp_soc.rccCminDP_125C.spef.gz
rcOut -rc_corner rccRCmaxDP_125C  -spef out/pulp_soc.rccRCmaxDP_125C.spef.gz
rcOut -rc_corner rccRCminDP_125C  -spef out/pulp_soc.rccRCminDP_125C.spef.gz

rcOut -rc_corner rccCmaxDP_M40C   -spef out/pulp_soc.rccCmaxDP_M40C.spef.gz
rcOut -rc_corner rccCminDP_M40C   -spef out/pulp_soc.rccCminDP_M40C.spef.gz
rcOut -rc_corner rccRCmaxDP_M40C  -spef out/pulp_soc.rccRCmaxDP_M40C.spef.gz
rcOut -rc_corner rccRCminDP_M40C  -spef out/pulp_soc.rccRCminDP_M40C.spef.gz

rcOut -rc_corner rccnominal_025C  -spef out/pulp_soc.rccnominal_025C.spef.gz
