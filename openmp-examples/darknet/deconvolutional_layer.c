...
layer make_deconvolutional_layer(int batch, int h, int w, int c, int n, int size, int stride,
...
void forward_deconvolutional_layer(const layer l, network net) {
  ...
  for (i = 0; i < l.batch; ++i) {
    ...
    col2im_cpu(net.workspace, l.out_c, l.out_h, l.out_w, l.size, l.stride, l.pad,
               l.output + i * l.outputs);
  }
  if (l.batch_normalize) {
...
void backward_deconvolutional_layer(layer l, network net) {
  ...
  for (i = 0; i < l.batch; ++i) {
    ...
    im2col_cpu(l.delta + i * l.outputs, l.out_c, l.out_h, l.out_w, l.size, l.stride, l.pad, b);
