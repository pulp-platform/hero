...
extern "C" void forward_deconvolutional_layer_gpu(layer l, network net) {
  ...
  for (i = 0; i < l.batch; ++i) {
    ...
    col2im_gpu(net.workspace, l.out_c, l.out_h, l.out_w, l.size, l.stride, l.pad,
               l.output_gpu + i * l.outputs);
  }
...
extern "C" void backward_deconvolutional_layer_gpu(layer l, network net) {
  ...
  for (i = 0; i < l.batch; ++i) {
    ...
    im2col_gpu(l.delta_gpu + i * l.outputs, l.out_c, l.out_h, l.out_w, l.size, l.stride, l.pad, b);
