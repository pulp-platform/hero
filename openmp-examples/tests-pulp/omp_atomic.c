 ...
 * https://github.com/llvm-mirror/openmp/blob/master/runtime/test/atomic/omp_atomic.c
 * Runtime error: Fatal: Trying to pop data although the FIFO is empty.
 * The test is splited into small tests for different operators. None of the small tests fails.
 * Tests for doubles have been commented on.
 */
...
*/
  ...
  //   result++;
  //   printf( "Error in division with double: Result was %f"
  //     " instead of 0.137787\n", div);
  // }
