...
// mmaxim: copied from https://stackoverflow.com/questions/1164652/printing-name-and-value-of-a-macro
# define STR(x)   #x
...
// mmaxim: this is what cyrill used:
//# define DATA_TYPE uint32_t
//# define DATA_PRINTF_MODIFIER "%u "
