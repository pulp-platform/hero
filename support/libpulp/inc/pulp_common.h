...
#define MAX_CLUSTERS 16
  ...
  #define H_GPIO_BASE_ADDR 0xA8080000
  #define CLKING_BASE_ADDR 0x00000000 // not supported
  #define RAB_CONFIG_BASE_ADDR 0xA8030000
  #define INTR_REG_BASE_ADDR 0xA8050000
...
#else // PLATFORM == ZYNQMP
  #define PULP_H_BASE_ADDR 0xB1000000 // Address at which the host sees PULP
  #define L1_MEM_H_BASE_ADDR PULP_H_BASE_ADDR
  #define L2_MEM_H_BASE_ADDR 0xB2000000
  #define L3_MEM_H_BASE_ADDR (0x80000000 - L3_MEM_SIZE_B)
  #define MBOX_H_BASE_ADDR 0xB3000000 // Interface 0
  #define SOC_PERIPHERALS_H_BASE_ADDR 0xB1000000 // FIXME
#endif // PLATFORM
