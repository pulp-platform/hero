...
source util/occamy_vcu128_procs.tcl

# Parse arguments
if {$argc < 6} {
    error "usage: occamy_vcu_138_flash.tcl HW_SERVER FPGA_ID MCS OFFSET0 FILE0 BIT0 [BOOTROM0]"
}
...
global occ_bit_stem
global occ_bootrom_script
set occ_hw_server $HW_SERVER
set occ_target_serial $FPGA_ID
set occ_hw_device xcvu37p_0
set occ_bootrom_script $BOOTROM0

#Remove the extension since vivado adds it
set occ_bit_stem [regsub ".bit" $BIT0 ""]

occ_program_bit

# Write bootrom
if {${occ_bootrom_script} ne ""} {
